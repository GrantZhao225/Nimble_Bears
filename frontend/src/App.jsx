...
// import ChatPage from './pages/ChatPage.jsx'; // ChatPage import removed (chat moved into ProjectDetailPage)
// import DMsPage from './pages/DMsPage.jsx'; // DMs moved into ProjectDetailPage
    ...
    <div className="app">
      ...
      <div className="main-content">
        <Routes>
          ...
          {/* Chat moved into ProjectDetailPage (no separate /chat route) */}
          {/* DMs moved into ProjectDetailPage (no separate /dms route) */}
